...
const App = () => {
  ...
  useEffect(() => {
    ...
    // Don't clear service workers as they're needed for PWA
    console.log('✅ Keeping service workers for PWA functionality');
  }, []);
  ...
  // PWA Status Check and Service Worker Registration
  useEffect(() => {
    ...
    const registerServiceWorkers = async () => {
      ...
      try {
        ...
        // Only register our app's service worker, not OneSignal's
        // OneSignal will register its own worker
        try {
          // Try to register the service worker generated by VitePWA
          ...
          try {
            ...
            console.log('✅ App service worker registered (sw.js):', appReg.scope);
            setPwaStatus(prev => ({ ...prev, serviceWorkerActive: true }));
          } catch (error2) {
            console.log('⚠️ Alternative service worker registration failed:', error2);
          }
        }
        ...
        <HashRouter>
          <UserProvider>
            ...
            <div className={isMobile ? "mobile-layout" : "desktop-layout"}>
              ...
              {/* PWA Install Prompt - Show when conditions are met */}
