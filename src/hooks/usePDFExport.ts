...
// UPDATED: Table drawing function with better rank and partnership support
...
export const usePDFExport = () => {
  const exportToPDF = useCallback(async ({ selectedDate, shiftName, shiftData }: ExportOptions) => {
    try {
      ...
      // Supervisors section - UPDATED: Use new supervisor formatting with ranks
      ...
      // SECTION 1: REGULAR OFFICERS TABLE - UPDATED: Use new officer formatting with partnerships
      ...
      // SECTION 2: SPECIAL ASSIGNMENT OFFICERS TABLE - UPDATED: Use new officer formatting with partnerships
