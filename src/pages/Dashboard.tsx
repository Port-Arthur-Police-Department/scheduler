...
import { Calendar, Users, AlertTriangle, Clock, LogOut, Bell, X, RefreshCw, Settings } from "lucide-react";
...
const Dashboard = ({ isMobile, initialTab = "daily" }: DashboardProps) => {
  ...
  }, [user, profile, primaryRole, isAdminOrSupervisor, roleLoading, isMobile]);
