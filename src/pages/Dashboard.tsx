...
import { DailyScheduleViewMobile } from "@/components/schedule/DailyScheduleViewMobile"; // ADDED: Mobile import
...
// Helper function to determine user's current shift - MOVE THIS TO TOP LEVEL
...
const Dashboard = ({ isMobile, initialTab = "daily" }: DashboardProps) => {
  ...
  useEffect(() => {
    ...
    else if (hash.startsWith('/settings')) setActiveTab('settings');
...
}, [user?.id, userCurrentShift, determiningShift, activeTab, profile?.full_name]);
...
// Add this when the component first renders
useEffect(() => {
